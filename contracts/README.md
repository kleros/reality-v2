# @kleros/reality-v2-contracts

Smart contracts for RealityV2
...
```bash
yarn deploy --network localhost --tags RealityV2
```
...
```bash
yarn deploy --network arbitrumSepolia --tags RealityV2
```
...
```bash
yarn hardhat node --tags RealityV2
```
